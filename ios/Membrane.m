...
RCT_EXTERN_METHOD(selectReceivedTrackTargetEncoding:(NSString)peerId withEncoding:(NSString)encoding withResolver:(RCTPromiseResolveBlock)resolve withRejecter:(RCTPromiseRejectBlock)reject)
